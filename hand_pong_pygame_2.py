...
while running:
    ...
    for b in extra_balls:
        ...
        if b.x - b.radius < PADDLE_WIDTH and abs(b.y - left_paddle_y) < left_paddle_h//2:
            b.dx *= -1
            b.dy += (left_paddle_y - b.y) * 0.08
            left_paddle_glow = PADDLE_GLOW_FRAMES
            if hit_sound:
                hit_sound.play()
        if b.x + b.radius > SCREEN_W - PADDLE_WIDTH and abs(b.y - right_paddle_y) < right_paddle_h//2:
            b.dx *= -1
            b.dy += (right_paddle_y - b.y) * 0.08
            right_paddle_glow = PADDLE_GLOW_FRAMES
            if hit_sound:
                hit_sound.play()
